...
class AddVideoContent extends GetView<AddVideoController> {
  const AddVideoContent({super.key});
          ...
          child: Column(
            ...
            children: [
              Align(
                ...
                child: InkWell(
                  onTap: () => SchedulerBinding.instance.addPostFrameCallback((_) => Get.offAllNamed(Routes.VIDEOS)),
                  child: Padding(
              ...
              Align(
                ...
                child: InkWell(
                  ...
                  child: GetBuilder<AddVideoController>(builder: (controller) {
              ...
              Gaps.vertical.r,
              AppTextField(
                label: const Text("Masukan link YouTube"),
                isError: false,
